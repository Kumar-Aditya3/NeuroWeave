TOPIC_BASE = {
    ...
    "fitness": "athletic motion language, explosive diagonals, interval cadence, sharp contrast",
...
TOPIC_GRAMMAR = {
    ...
    "fitness": {
        "geometry": "explosive diagonals, sprint-lane vectors, impact arcs, radial pulse rings",
        "composition": "forward-driving diagonal flow with clear momentum corridor",
        "density": "high",
    },
